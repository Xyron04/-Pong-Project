...
//Función que dibuja un rectángulo en la pantalla LCD. 
void drawFilledRectangle(int x1, int y1, int x2, int y2);

//Función que copia a la pantalla todos los cambios realizados
void copyToScreen(void);

//Función que borra un rectángulo
void clearFilledRectangle(int x1, int y1, int x2, int y2);

//Función que escribe un texto en la pantalla nokia
void text(int x, int y, const unsigned char s[], unsigned int font);

//Función que muestra en la pantalla el menú modo
void menu_modo(uint8_t modo);

//Función que muestra en la pantalla el menú control
void menu_control(uint8_t control);

//Función que muestra en la pantalla el menú dificultad
void menu_dificultad(uint8_t opc);

//Función que muestra en la pantalla el menú de inicio
void menu_inicio(void);

//Función que limpia el Buffer
void clearBuffer(void);

//Función que muestra en la pantalla la victoria del cpu
void gana_cpu(void);

//Función que muestra en la pantalla la victoria del jugador ante el cpu
void gana_jugador(void);

//Función que muestra en la pantalla la victoria del j1
void ganador_j1(void);

//Función que muestra en la pantalla la victoria del j2
void ganador_j2(void);

//Función que muestra en la pantalla el fondo
